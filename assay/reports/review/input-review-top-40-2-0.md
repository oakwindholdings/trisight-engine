...
- **`trisight-trader/docs_output/TOP_40_2_0_LOCKDOWN_SPEC.md:14-22,187,338-354`**
  → <https://github.com/oakwindholdings/TriSight/blob/main/docs_output/TOP_40_2_0_LOCKDOWN_SPEC.md>
- **`orchestration/reports/DEFECT-REGISTRY.md:78 (D58)`**
  → <https://github.com/oakwindholdings/trisight-engine/blob/main/assay/reports/review/evidence/DEFECT-REGISTRY.md>
- **`orchestration/reports/DECISIONS-INBOX.md:332 (seal 50f02064)`**
  → <https://github.com/oakwindholdings/trisight-engine/blob/main/assay/reports/review/evidence/DECISIONS-INBOX.md>
- **`orchestration/reports/DEFECT-REGISTRY.md:109 (D77), :519-521, :697`**
  → <https://github.com/oakwindholdings/trisight-engine/blob/main/assay/reports/review/evidence/DEFECT-REGISTRY.md>
- **`orchestration/reports/CARD-99-TRADELOG-FORENSICS.md:104`**
  → <https://github.com/oakwindholdings/trisight-engine/blob/main/assay/reports/review/evidence/CARD-99-TRADELOG-FORENSICS.md>
- **`trisight-trader/docs_output/gate_conjunction_blast_radius_20260808/prod_auto_top40_2_0_trade_log.csv`**
  → <https://github.com/oakwindholdings/TriSight/blob/main/docs_output/gate_conjunction_blast_radius_20260808/prod_auto_top40_2_0_trade_log.csv>
