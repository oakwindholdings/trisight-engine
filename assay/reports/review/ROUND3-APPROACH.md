...
| **Oakwind Swing** | **Window established** 2025-01-02→2026-05-14 (WI-2.4, cross-confirmed against two independently-generated committed CSVs, hash-verified; 356 weekdays ≈ market_days 355). The 9,408 executed span those ~16 months, not one day — your objection is answered by our data. Venue = TriSight Sim, from code (WI-3). | None — established from our own data. (FYI only: flag if this conflicts with anything on your end.) |
