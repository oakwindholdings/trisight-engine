...
- [ ] ISC-125: On the demo data the worst slice is materially worse than the headline OR the failure-to-find is itself reported (A4)
...
- ISC-139 (A5): gate [6/7] replay + forged-trace drift test (red-first).
- ISC-140 (A6): gate [7/7]; fake-key sweep over every object and trace in tests; live key is empty (attempt transcript in Decisions).
...
- ISC-142..146, 148, 150: greps in gate [4/7]+[5/7]; red-first evidence for A2/A3/A5/redaction as cited; no Python files exist.
