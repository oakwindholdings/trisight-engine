...
> Ratified by Dick O'Leary, 2026-08-21 (posted as PR #3 comment). Binds every agent
> working in this repository. Injected into every subagent prompt together with
> `COVENANT.md` by `.claude/hooks/covenant-inject.cjs`.
